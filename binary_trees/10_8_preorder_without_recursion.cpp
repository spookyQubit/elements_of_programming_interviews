...
using namespace std;
/*
Purpose: Given a binary tree, perform an preorder traversal without using recursion.
*/
...
template <typename T>
void preorder_without_recursion(const shared_ptr<BinaryTreeNode<T> >& root)
{
...
void test1()
{
	...
	*/
	...
	preorder_without_recursion<int>(root);
